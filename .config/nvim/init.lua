...
vim.o.tabstop = 4 -- Set number of spaces a tab represents
vim.o.shiftwidth = 4 -- Set number of spaces to use for each indentation
vim.o.expandtab = true -- Set true to use spaces instead of tabs
